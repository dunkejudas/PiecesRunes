...
namespace UnitySampleAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonUserControl_piecesOverride : ThirdPersonUserControl
    {
        ...
        private void FixedUpdate()
        {
            ...
            //PIECES OVERRIDE
            //For now: Do not allow any input other than jump from the user
            ...
            //PIECES OVERRIDE
            //For now: move direction will always be straight ahead
            /*
            ...
            */
            ...
            //PIECES OVERRIDE
            //For now: No ability to slow down with walk
            /*
            ...
            */
            ...
            //PIECES OVERRIDE
            //Custom call to Move() with set arguments
            // pass all parameters to the character control script
            //character.Move(move, crouch, jump, lookPos);
            character.Move(move, false, jump, move);
            jump = false;
        }
    }
}